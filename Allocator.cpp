...
, m_window( wnd )
{
	...
	m_pSprite = new CSprite(m_D3DDev,640,480);
}
            ...
            /* [out][in] */ DWORD *lpNumBuffers)
{
    ...
    if( d3dcaps.TextureCaps & D3DPTEXTURECAPS_POW2 )
    {
		...
		m_pSprite->CreateVertex(0,0,640,480);
		m_pSprite->LoadTexture(".\\Sprite\\MAINMENU_BG.bmp");
...
HRESULT CAllocator::PresentHelper(VMR9PresentationInfo *lpPresInfo)
{
    ...
    {   
		...
		m_pSprite->SetTexture( m_privateTexture );
